...
\begin{itemize}[parsep=0.5ex]
  \item \textbf{Languages:} C\#, Python, TypeScript JavaScript, PHP.
  \item \textbf{Tools:} Azure Cosmos DB, SQL Server, 
  \item \textbf{Front-end and Back-end devlelopment:} Angular, React, Laravel.
  \item \textbf{Languages ability:} English(Fluent), Mandarin(Native).
\end{itemize}

\section{Experience}
\datedsubsection{\textbf{Software Development Engineer, Microsoft Suzhou, Viva Topics team}}{Oct. 2022 - Present}
\begin{itemize}
  \item 
  \item 
  \item 
...
\datedsubsection{\textbf{Software Development Engineer, Microsoft Suzhou, SharePoint Server team}}{Mar. 2021 - Oct. 2022}
\begin{itemize}
  \item Developed PowerShell scripts to automate scanning and collection of DLL references, ensuring adherence to standard practices in packaging and uploading to NuGet. Significantly reducing DLL dependencies from 1200+ to 270 DLLs. 
  \item Refactored and migrated over 100 projects from old codebase to new project in Office Engineering System, resulting in a more consistent developer experience and increased efficiency. 
  ...
  \item Fixed security vulnerabilities by resolving CredScan bugs, OACR errors, and contributed new features to SPWFM. Additionally, facilitated SharePoint test v-team in setting up Workflow Manager farm and services, ensuring smooth testing processes and preventing regressions.
\end{itemize}

\datedsubsection{\textbf{Software Development Intern, Microsoft Beijing, Cloud+AI Group}}{Jun. 2019 - Sept. 2019}
\begin{itemize}
